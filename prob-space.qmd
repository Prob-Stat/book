...
任意の $x\in[0, 1)$ について、ある $z\in V$ が唯一存在して $x\sim z$ である。
よって、
\begin{align*}
[0, 1) &= \bigcup_{z\in V} \{x \mid x\sim z\}\\
&= \bigcup_{z\in V} \bigcup_{q\in\mathbb{Q}} (\{z\} + q)\\
&= \bigcup_{q\in\mathbb{Q}} \bigcup_{z\in V}  (\{z\} + q)\\
&= \bigcup_{q\in\mathbb{Q}} (V + q)\\
\end{align*}
である。よって、
\begin{align*}
1 = P([0, 1)) &= P\left(\bigcup_{q\in\mathbb{Q}} V+q\right)\\
 &= \sum_{q\in\mathbb{Q}} P\left(V+q\right)\\
 &= \sum_{q\in\mathbb{Q}} P\left(V\right)
\end{align*}
:::
