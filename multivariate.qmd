...
\quad\forall x_1\in\mathrm{Image}(X_1),x_2\in\mathrm{Image}(X_2).
\end{align*}
:::
::: {.proof}
$\Longrightarrow$ は自明。
...
このとき、
\begin{align*}
\Pr(X_1=x_1,\,X_2=x_2) &= \frac14\qquad\forall x_1,x_2\in\{0,1\}\\
\Pr(X_1=x_1)=\Pr(X_2=x_2)&=\frac12\qquad\forall x_1,x_2\in\{0,1\}
\end{align*}
より $\Pr(X_1=x_1,\,X_2=x_2) = \Pr(X_1=x_1)\Pr(X_2=x_2)$ を満たすことが分かる。
