...
連続確率変数 $X_1$ と $X_2$ が独立で密度関数を持つとき、$X_1+X_2$ は確率密度関数を持ち
\begin{align*}
f_{X_1+X_2}(x) &= \int_{-\infty}^\infty f_{X_1}(z)f_{X_2}(x-z)\mathrm{d} z
\end{align*}
が成り立つ。
確率変数 $X_1,\,X_2$ が独立で $X_1\sim N(\mu_1,\,\sigma_1)$, $X_2\sim N(\mu_2,\,\sigma_2)$ とする。
このとき、
\begin{align*}
f_{X_1+X_2}(x) &= \int_{-\infty}^\infty f_{X_1}(z)f_{X_2}(x-z)\mathrm{d} z\\
 ...
 &= \frac1{2\pi\sqrt{\sigma_1^2\sigma_2^2}}\int_{-\infty}^\infty  \mathrm{e}^{-\frac{(\sigma_1^2+\sigma_2^2)(z-\mu_1)^2+\sigma_1^2(x-z-\mu_2)^2}{2\sigma_1^2\sigma_2^2}}\mathrm{d} z\\
\end{align*}
